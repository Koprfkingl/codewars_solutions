"""Kata - Multi-tap Keypad Text Entry on an Old Mobile Phone

completed at: 2019-04-25 19:40:29
by: Jakub Červinka
...
def presses(phrase):
    ...
    press = '123123123123123123412312341144444545211'
    num_pres = dict(zip(chars, press))
    return sum(int(num_pres[c]) for c in phrase.upper())
